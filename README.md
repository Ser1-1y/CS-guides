...
- Артериальные дороги имеют более высокие ограничения по скорости, а приоритет на них даётся машинам. Однако, развязки на этих дорогах не позволительны, предпочтительны светофоры.
